    ...
    <div className="p-5 min-h-screen">
      ...
      >
        ...
        <div className="collapse-content ">
          ...
          <p>
            1. URL <br /> 2. Web Storage <br /> 3. Local State <br /> 4. Lifted
            State <br />
            5. Derived State{" "}
          </p>
        </div>
      ...
      >
        ...
        <div className="collapse-content ">
          <p>
            ...
            difficult to find in later testing stages. Thats why we should write
            it.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="collapse-content ">
          <p>
            ...
            <br />
            If the choice you are making is based on Angular vs React alone,
            then you will simply need to consider the pros and cons discussed
            ...
            a full-fledged solution that does not require extras like React
          ...
          <p>
            ...
            churning out lots of new components and extras, so there is no sign
            that React is on the decline either.
            <br />
            ...
            HTML templates along with JSX is an advantage.
          </p>
          <p>
            <strong>Angular vs Vue</strong> <br />
            In most cases, you probably would not be deciding between only
            ...
            those working on larger apps.
            <br />A large library like Angular would require more diligence in
            keeping up with what is new, while Vue would be less demanding in
            this regard and the fact that the two most recent major releases of
            Vue are in separate repositories helps.
          </p>
        </div>
      </div>
    </div>
